...
var servicePort = configuration.get("applications:rabbit:services:error:port");

http.createServer(app).listen(servicePort);

log.info(configuration.get("applications:rabbit:services:error:name") + ' server listening: ' + servicePort + ' port');